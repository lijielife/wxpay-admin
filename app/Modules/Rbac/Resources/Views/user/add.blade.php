<div class="validform" style="width: 430px;">
    <form id="jq_add_form_user" action="/rbac/user/save" method="post">
        {!! csrf_field() !!}
        ...
        <table style="table-layout:fixed; width: 100%;">
            <tr>
                ...
                <td>
                    <input type="text" id="name" name="name" class="inputxt" datatype="s2-24" nullmsg="请输入姓名" errormsg="姓名必须是2~24位"/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="email" name="email" class="inputxt" datatype="e" nullmsg="请输入邮箱"  errormsg="请输入正确的邮箱地址"/>
                </td>
                <td class="need">*</td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="password" id="password" name="password" class="inputxt" datatype="s8-18" nullmsg="请输入登陆密码"  errormsg="密码必须是8~18位"/>
                </td>
                <td class="need">*</td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="password" id="repassword" name="repassword" class="inputxt" recheck="password" datatype="s8-18" nullmsg="请重新输入登陆密码"  errormsg="密码必须是8~18位"/>
                </td>
                <td class="need">*</td>
            </tr>
        </table>
...
require(['util', 'valid_form', 'valid_form_datatype', 'easyui'], function(util){
    $('#jq_add_form_user input').focus(function() {
    ...
    util.createWindow['jq_add_form_user'] = $('#jq_add_form_user').Validform(formOptions);

    $('#role_tree').tree({
        checkbox: true,
        cascadeCheck: false,
        url : '/rbac/role/role-tree.json',
