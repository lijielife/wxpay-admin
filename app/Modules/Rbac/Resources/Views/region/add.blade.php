<div class="validform business_info" style="height: 300px; overflow-y: auto; padding: 0 10px;">
    <form id="jq_add_form_region" action="/region/save" method="post">
        {!! csrf_field() !!}
        ...
        <table style="table-layout:fixed; width: 100%;" cellspacing="10">
            <tr>
                ...
                <td style="width:205px;">
                    <input type="text" id="name" name="name" class="inputxt" datatype="*" nullmsg="请输入区域名称"/>
                </td>
                <td class="need" style="width:20px;">*</td>
                <td><div class="Validform_checktip"></div></td>
                <td style="width:100px; text-align: right;">区域简称：</td>
                <td style="width:205px;">
                    <input type="text" id="short_name" name="short_name" class="inputxt" datatype="*" nullmsg="请输入区域简称"/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="zip_code" name="zip_code" class="inputxt" datatype="*" nullmsg="请填写邮编"/>
                </td>
                <td class="need">*</td>
                <td><div class="Validform_checktip"></div></td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" id="city_code" name="city_code" class="inputxt" datatype="*" nullmsg="请填写城市编码"" />
                </td>
                <td class="need">*</td>
                <td><div class="Validform_checktip"></div></td>
                <td style="text-align: right;">区域编码：</td>
                <td>
                    <input type="text" id="area_code" name="area_code" class="inputxt" datatype="*" nullmsg="请填写区域编码" />
                </td>
                <td class="need">*</td>
                <td><div class="Validform_checktip"></div></td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" id="pinyin" name="pinyin" class="inputxt"/>
                </td>
                <td class="need">*</td>
                <td><div class="Validform_checktip"></div></td>
                <td style="text-align: right;">经度：</td>
                <td>
                    <input type="text" id="lng" name="lng" class="inputxt"/>
                </td>
                <td class="need">*</td>
                <td><div class="Validform_checktip"></div></td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" id="lat" name="lat" class="inputxt"/>
                </td>
                <td class="need"></td>
                <td><div class="Validform_checktip"></div></td>
            </tr>
...
require(['util', 'easyui.widget.extend'], function(util){
    util.createWindow['jq_add_form_region'] = $('#jq_add_form_region').Validform({confirmBeforeSubmit: true});

    $('#jq_add_form_region input').focus(function() {
