<div class="validform business_info" style="height: 450px; overflow-y: auto; padding: 0 10px;">
    ...
    <table style="table-layout:fixed; width: 100%;" cellspacing="10">
        <tr>
            ...
            <td style="width:200px;">
                <input type="text" id="billing_rate" name="billing_rate" value="{{ $merchantPayment->billing_rate }}" class="inputxt easyui-numberbox" data-options="precision:2,min:0,suffix:'‰',height:32" datatype="isDecimals2" nullmsg="请输入结算费率" errormsg="结算费率只能是数字，且小数点最多两位"/>
            </td>
            <td style="width:5px" class="need">*</td>
            <td style="width:1px;"><div class="Validform_checktip"></div></td>
        </tr>
    ...
    <form id="jq_edit_form_merchantPayConf" action="/merchant/payment/save" method="post">
        ...
        <input type="hidden" id="jq_edit_form_merchantPayConf_activateStatus" name="activate_status"/>
