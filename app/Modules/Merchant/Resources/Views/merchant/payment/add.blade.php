<div class="validform business_info" style="height: 450px; overflow-y: auto; padding: 0 10px;">
    <form id="jq_add_form_merchantPayConf" action="/merchant/payment/save" method="post">
        {!! csrf_field() !!}
        <input type="hidden" name="merchant_id" value="{{ $merchant->id }}"/>
        <input type="hidden" id="billing_account_id" name="billing_account_id"/>
        ...
        <table style="table-layout:fixed; width: 100%;" cellspacing="10">
            <tr>
                ...
                <td style="width:200px;">
                    <input type="text" id="merchantName" value="{{ $merchant->name }}" class="inputxt" disabled="disabled"/>
                </td>
                ...
                <td style="width:200px;">
                    <input type="text" id="payment_id" name="payment_id" boxValue="" boxText="" class="inputxt" datatype="*" nullmsg="请选择支付类型"/>
                </td>
                <td style="width:5px;" class="need">*</td>
                <td style="width:1px;"><div class="Validform_checktip"></div></td>
                <td style="width:100px; text-align: right;">结算费率(‰)：</td>
                <td style="width:200px;">
                    <input type="text" id="billing_rate" name="billing_rate" value="" class="inputxt easyui-numberbox" data-options="precision:2,min:0,suffix:'‰',height:32" datatype="isDecimals2" nullmsg="请输入结算费率" errormsg="结算费率只能是数字，且小数点最多两位"/>
                </td>
                <td style="width:5px" class="need">*</td>
                <td style="width:1px;"><div class="Validform_checktip"></div></td>
            </tr>
            <tr>
                ...
                <td style="width:200px;">
                    <input type="text" id="daily_trading_limit" name="daily_trading_limit" value="" class="inputxt easyui-numberbox" data-options="precision:2,min:0,prefix:'￥',height:32" datatype="isDecimals2" nullmsg="请输入日交易限额" errormsg="日交易限额只能是数字，且小数点最多两位"/>
                </td>
                <td style="width:5px" class="need">*</td>
                <td style="width:1px;"><div class="Validform_checktip"></div></td>
                <td style="text-align: right;">单笔最大限额：</td>
                <td>
                    <input type="text" id="single_max_limit" name="single_max_limit" value="" class="inputxt easyui-numberbox" data-options="precision:2,min:0,prefix:'￥',height:32" datatype="isDecimals2" nullmsg="请输入单笔最大限额" errormsg="单笔最大限额只能是数字，且小数点最多两位"/>
                </td>
                <td class="need">*</td>
                <td><div class="Validform_checktip"></div></td>
                <td style="text-align: right;">单笔最小限额：</td>
                <td>
                    <input type="text" id="single_min_limit" name="single_min_limit" value="" class="inputxt easyui-numberbox" data-options="precision:2,min:0,prefix:'￥',height:32" datatype="isDecimals2" nullmsg="请输入单笔最小限额" errormsg="单笔最小限额只能是数字，且小数点最多两位"/>
                </td>
                <td class="need">*</td>
                <td><div class="Validform_checktip"></div></td>
            </tr>
        ...
        <table cellspacing="10" style="table-layout:fixed; width: 100%;">
            <tr>
                ...
                <td style="width:200px; ">
                    <input type="text" id="merchant_no" name="merchant_no" value="" class="inputxt" nullmsg="请输入商户号"/>
                </td>
                <td style="width:5px;" class="need">*</td>
                <td style="width:1px;"><div class="Validform_checktip"></div></td>
            ...
            <div class="info_title">
                ...
                <input id="jq_link_account_checkbox" type="checkbox" name="jq_link_account_checkbox" value="true" style="vertical-align: middle;"/>
            </div>
...
require(['util', 'easyui.widget.extend'], function(util) {
    util.createWindow['jq_add_form_merchantPayConf'] = $('#jq_add_form_merchantPayConf').Validform({confirmBeforeSubmit: true});

    $('#jq_add_form_merchantPayConf input').focus(function() {
    ...
    var alertAccountSearchPanel = function() {
        ...
        $.extWidget.SearchPanel({
            dialogTitle:'选择结算账户',
            url: '/merchant/accounts/{{ $merchant->id }}',
            method: 'get',
            queryParams: {},
