                                        ...
                                        onChange: function(rec){
                                            ...
                                            $('#city').combobox({
                                                ...
                                                loadFilter: function(data) {
                                                    var cityValue = {{ empty($merchant->city) ? 0 : $merchant->city }};
                                                    $('#city').val(cityValue);
                                                    $.each(data, function() {
            ...
            <div class="info_upload">
                ...
                <div class="upload_list">
                    <span class="upload_box">
                        ...
                        <img src="/download?path={{ $merchant->business_licence_pic }}" width="170" height="120">
                        @else
                        营业执照
                        @endif
                        </div>
                    ...
                    <span class="upload_box">
                        ...
                        <img src="/download?path={{ $merchant->identity_card_pic['front'] }}" width="170" height="120">
                        @else
                        商户负责人身份证
                        @endif
                        </div>
                    ...
                    <span class="upload_box">
                        ...
                        <img src="/download?path={{ $merchant->org_code_cert_pic }}" width="170" height="120">
                        @else
                        组织机构代码证
                        @endif
                        </div>
                    ...
                    <span class="upload_box">
                        ...
                        <img src="/download?path={{ $merchant->merchant_protocol_pic[0] }}" width="170" height="120">
                        @else
                        商户协议
                        @endif
                        </div>
            ...
            <div class="info_upload">
                    ...
                    <span class="upload_box">
                        <div class="upload_img jq_upload_img_class" id="jq_jq_upload_protocolPhoto2_img_div" title="商户协议图二">
                            @if(!empty($merchant->merchant_protocol_pic[1]))
                            <img src="/download?path={{$merchant->merchant_protocol_pic[1]}}" width="170" height="120">
                            @else
                            商户协议图二
                            @endif
                        </div>
                    ...
                    <span class="upload_box">
                          <div class="upload_img jq_upload_img_class" id="jq_jq_upload_protocolPhoto3_img_div" title="商户协议图三">
                            @if(!empty($merchant->merchant_protocol_pic[2]))
                            <img src="/download?path={{$merchant->merchant_protocol_pic[2]}}" width="170" height="120">
                            @else
                            商户协议图三
                            @endif
                          </div>
                    ...
                    <span class="upload_box">
                        <div class="upload_img jq_upload_img_class" id="jq_jq_upload_protocolPhoto4_img_div" title="商户协议图四">
                            @if(!empty($merchant->merchant_protocol_pic[3]))
                            <img src="/download?path={{$merchant->merchant_protocol_pic[3]}}" width="170" height="120">
                            @else
                            商户协议图四
                            @endif
                        </div>
                        ...
                        <div class="upload_list" id="jq_merchant_indentityPhoto_upload_list">
                            ...
                            <span class="upload_box">
                                <div class="upload_img jq_upload_img_class" id="jq_jq_upload_idcard2_img_div" title="身份证反面">
                                    @if(!empty($merchant->identity_card_pic['back']))
                                    <img src="/download?path={{$merchant->identity_card_pic['back']}}" width="170" height="120">
                                    @else
                                    身份证反面
                                    @endif
                                </div>
    ...
    $('#type').combobox({
        ...
        onSelect: function(rec){
            ...
            if (rec.value == 'heavy') {
                ...
                $('#pid').removeAttr('datatype');
                $('#pid').removeAttr('nullmsg');
            } else if ((rec.value == 'direct' || rec.value == 'normal' || rec.value == 'chain') && !$('#channel_id').val()){
                $('#pid').textbox('enable');
                $('#pid').attr('datatype', '*');
                $('#pid').attr('nullmsg', '请选择所属大商户');
            }
