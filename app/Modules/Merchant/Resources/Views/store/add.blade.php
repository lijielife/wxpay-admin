<div class="validform">
	<form id="jq_add_form_store" action="/merchant/store/save" method="post">
		{!! csrf_field() !!}
		<table style="table-layout:fixed; width: 100%;">
			<tr>
				<td style="width:80px; text-align: right;">所属大商户：</td>
				<td style="width:205px;">
					<input type="text" id="pid" name="pid" class="inputxt" datatype="*" nullmsg="请选择大商户"/>
				</td>
			...
			<tr>
				...
				<td>
					<input type="text" id="name" name="name" class="inputxt" datatype="*4-50" nullmsg="请输入门店名称" errormsg="商户名称长度在4~50位之间！"/>
				</td>
				<td class="need">*</td>
				<td><div class="Validform_checktip"></div></td>
			</tr>
...
require(['util', 'easyui.widget.extend'], function(util){
	util.createWindow['jq_add_form_store'] = $('#jq_add_form_store').Validform();
	$('#jq_add_form_store input').focus(function() {
